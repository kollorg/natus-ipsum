...
[![addon-console](https://img.shields.io/npm/dt/@kollorg/natus-ipsum.svg)](https://github.com/kollorg/natus-ipsum)
...
[![storybook-addon-console](https://raw.githubusercontent.com/kollorg/natus-ipsum/master/docs/storybook-addon-console.png)](https://raw.githubusercontent.com/kollorg/natus-ipsum/master/docs/storybook-addon-console.png)
...
## API
<a name="module_@kollorg/natus-ipsum"></a>
...
* [@kollorg/natus-ipsum](#module_@kollorg/natus-ipsum)
    * _static_
        * [.setConsoleOptions(optionsOrFn)](#module_@kollorg/natus-ipsum.setConsoleOptions) ⇒ <code>addonOptions</code>
        * [.withConsole([optionsOrFn])](#module_@kollorg/natus-ipsum.withConsole) ⇒ <code>function</code>
    * _inner_
        * [~addonOptions](#module_@kollorg/natus-ipsum..addonOptions) : <code>Object</code>
        * [~optionsCallback](#module_@kollorg/natus-ipsum..optionsCallback) ⇒ <code>addonOptions</code>

<a name="module_@kollorg/natus-ipsum.setConsoleOptions"></a>

### @kollorg/natus-ipsum.setConsoleOptions(optionsOrFn) ⇒ <code>addonOptions</code>
Set addon options and returns a new one

**Kind**: static method of [<code>@kollorg/natus-ipsum</code>](#module_@kollorg/natus-ipsum)  
**See**
...
```
<a name="module_@kollorg/natus-ipsum.withConsole"></a>

### @kollorg/natus-ipsum.withConsole([optionsOrFn]) ⇒ <code>function</code>
...
```
<a name="module_@kollorg/natus-ipsum..addonOptions"></a>

### @kollorg/natus-ipsum~addonOptions : <code>Object</code>
This options could be passed to [withConsole](#storybookaddon-consolewithconsoleoptionsorfn--function) or [setConsoleOptions](#module_@kollorg/natus-ipsum.setConsoleOptions)

**Kind**: inner typedef of [<code>@kollorg/natus-ipsum</code>](#module_@kollorg/natus-ipsum)  
**Properties**
...
<a name="module_@kollorg/natus-ipsum..optionsCallback"></a>

### @kollorg/natus-ipsum~optionsCallback ⇒ <code>addonOptions</code>
